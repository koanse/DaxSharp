...
{
    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_Max()
    {
        var sales = new[]
        {
        ...
        Assert.Equal("[21,31,1,1,1,11]", expressionsString);
    }

    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum()
    {
        var sales = new[]
        {
        ...
        Assert.Equal("[{\"productId\":\"1\",\"customerId\":\"2\"}," +
                     ...
                     "{\"productId\":\"2\",\"customerId\":\"3\"}," +
                     "{\"productId\":\"3\",\"customerId\":\"3\"}]", groupsString);
        Assert.Equal("[21,31,1,1,1,1]", expressionsString);
    }

    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_Two_Filters()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = (int?)10 },
    ...
    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_Two_Filters_GroupFilter()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = (int?)10 },
    ...
    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_Two_Filters_GroupFilter_NoData()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = (int?)10 },
    ...
    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_NoFilters()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = (int?)10 },
    ...
    [Fact]
    public void SummarizeColumnsCartesian_ConstantInExpressions_Sum_NoFilters_NoGrouping()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = (int?)10 },
    ...
    public void SummarizeColumns_NoConstantInExpressions()
    {
        ...
        var result = sales.SummarizeColumns(
            x => new { x.productId, x.customerId },
            (x, g) => x is { customerId: not "2" } || g is { productId: not null },
        ...
        Assert.Equal("[0]", expressionsString); // TODO PBI
    }

    [Fact]
    public void SummarizeColumnsCartesian_NoConstantInExpressions()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = 10 },
        ...
        Assert.Equal("[{\"productId\":\"1\",\"customerId\":\"2\"}," +
                     ...
                     "{\"productId\":\"2\",\"customerId\":\"3\"}," +
                     "{\"productId\":\"3\",\"customerId\":\"3\"}]", groupsString);
        Assert.Equal("[20,30,0,0,0,10]", expressionsString);
    }

    [Fact]
    public void SummarizeColumnsCartesian_NoConstantInExpressions_GroupFilter()
    {
        var sales = new[]
        {
            new { productId = "1", customerId = "2", amount = 10 },
    ...
    [Fact]
    public void SummarizeColumnsCartesian_NoConstantInExpressions_MaxCount()
    {
